...
method synthesize*(module: DcOffsetModule, x: float64, pin: int, moduleList: array[256, SynthModule]): float64 =
    if(module.inputs[0].moduleIndex < 0): return 0
    let moduleA = moduleList[module.inputs[0].moduleIndex]
    if(moduleA == nil): return 0.0 else: return moduleA.synthesize(x, module.inputs[0].pinIndex, moduleList) + module.offset
